/* =========================================================================
   FIREBASE SYNC — shared by round1.js (control page) and status.js
...
const bracket1Ref = ref(db, 'bracket1');

/**
 * Subscribes to live changes on Bracket 1's state. Calls `callback`
...
export function subscribeState(callback) {
  onValue(bracket1Ref, (snapshot) => callback(snapshot.val()));
}
